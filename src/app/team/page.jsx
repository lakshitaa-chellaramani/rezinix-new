...
const LeadershipSection = () => {
  const leaders = [
    {
      name: "Sachin Jain",
      title: "Director",
      image: "https://rezinix.ai/images/2025-05-Sachin-Jain-1.webp", // Replace with actual image path
    ...
    },
    {
      ...
      image: "https://rezinix.ai/images/2025-05-nitin-sawant-1.webp", // Replace with actual image path
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col lg:flex-row gap-8 mb-8">
              ...
              <div className="flex-grow space-y-4">
                <div>
                  <h3 className="text-3xl font-bold text-gray-900 group-hover:text-red-600 transition-colors      mb-2">
                    {leader.name}
                  </h3>
                  <div className={`inline-block bg-gradient-to-r ${leader.color} text-white px-4 py-2      text-sm font-bold tracking-wider`}>
                    {leader.title}
                  </div>
                </div>
                ...
                {/* Specialties */}
                <div>
                  <div className="text-gray-900      text-sm font-bold mb-2">EXPERTISE:</div>
                ...
                {/* Key Achievements */}
                <div>
                  <div className="text-gray-900      text-sm font-bold mb-2">KEY ACHIEVEMENTS:</div>
            ...
            <div className="space-y-4">
              <h4 className="text-lg font-bold text-gray-900     ">BIOGRAPHY</h4>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              <button className="group bg-gradient-to-r from-red-600 to-orange-600 text-white px-6 py-3      font-bold text-sm tracking-wider flex items-center justify-center space-x-2 border border-red-500/50 relative overflow-hidden hover:shadow-lg flex-1">
              ...
              <button className="group text-gray-900 border border-gray-400 px-6 py-3      font-bold text-sm tracking-wider hover:border-red-400 hover:text-red-400 transition-all duration-300 relative bg-white hover:shadow-lg flex items-center justify-center space-x-2 flex-1">
  ...
  return (
    <section className="py-20 px-4 mt-14 sm:px-6 lg:px-8 relative bg-white">
      {/* Scanning Lines */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-6xl small font-bold mb-6     ">
